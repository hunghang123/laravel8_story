                                    ...
                                    <div class="card-body">
                                        ...
                                        @if (session('status'))
                                         ...
                                         {{ session('status') }}
                                          ...
                                          @endif
                                        <form action="{{route('banner.update',[$danhmuc->banner_id])}}" method="post" novalidate="novalidate">
                                        @method('PUT')
                                         @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="banner_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$danhmuc->banner_name}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Tên link</label>
                                                <input id="cc-payment" name="banner_url" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$danhmuc->banner_url}}">
                                            </div>
                                            <div class="form-group has-success">
                                                  <label for="file-input" class=" form-control-label">úp ảnh</label>
                                                  <input id="input" name="banner_image" placeholder=" hình" type="text" class="form-control" value="{{$danhmuc->banner_image}}" > 
                                                  <img src="{{asset($danhmuc->banner_image)}}" height="150px" width="150px">
                                            </div>
