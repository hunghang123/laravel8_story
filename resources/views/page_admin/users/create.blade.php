...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Thêm danh sách khách hàng</strong>
                            </div>
                            @if ($errors->any())
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('user.store')}}" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-payment" name="email" type="email" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">phone</label>
                                                <input id="cc-payment" name="phone" type="phone" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Password</label>
                                                <input id="cc-payment" name="password" type="password" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                           
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Address</label>
                                                <input id="cc-payment" name="address" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="role" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                                     </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block" name="add_user">
