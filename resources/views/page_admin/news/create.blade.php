...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Thêm tin tức</strong>
                            </div>
                            @if ($errors->any())
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if (session('status'))
                                         ...
                                         {{ session('status') }}
                                          ...
                                          @endif
                                        <form action="{{route('news.store')}}" method="post" novalidate="novalidate" >
                                            @csrf()
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="news_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                          
                                            
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Tên content</label>
                                                <input id="cc-payment" name="news_content" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Mô tả</label>
                                                <textarea id="cc-name" name="news_desc" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"  aria-required="true" aria-invalid="false" aria-describedby="cc-name"></textarea>
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                           
                                            <div class="form-group has-success">
                                                  <label for="file-input" class=" form-control-label">úp ảnh</label>
                                                  <input id="input" name="news_image" placeholder=" hình" type="text" class="form-control" > 
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Tên capture</label>
                                                <input id="cc-payment" name="news_capture" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                ...
                                <div class="col-12 col">
                                    <select name="category" id="selectSm" class="form-control-sm form-control">
                                        ...
                                        @foreach($danhmuctintuc as $key => $value)
                                                @if($value->news_category_name==0)
                                                    <option value="{{$value->news_category_id}}">{{$value->news_category_name}}</option>
                                                @endif
                                            @endforeach
                                    </select>
                                </div>
