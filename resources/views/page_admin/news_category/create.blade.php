...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Thêm danh mục tin tức</strong>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if (session('status'))
                                         ...
                                         {{ session('status') }}
                                          ...
                                          @endif
                                        <form action="{{route('news_category.store')}}" method="post" novalidate="novalidate">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="news_category_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
