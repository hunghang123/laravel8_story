                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('category.store')}}" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="category_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Mô tả</label>
                                                <textarea id="cc-name" name="category_desc" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"  aria-required="true" aria-invalid="false" aria-describedby="cc-name"></textarea>
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                  <label for="file-input" class=" form-control-label">úp ảnh</label>
                                                  <input id="input" name="category_image" placeholder=" hình" type="text" class="form-control" > 
                                            </div>
