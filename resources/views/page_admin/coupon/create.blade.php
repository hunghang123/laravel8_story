...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Thêm mã</strong>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('coupon.store')}}" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="coupon_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Mã giảm giá</label>
                                                <input id="cc-payment" name="coupon_code" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Số lượng mã</label>
                                                <input id="cc-payment" name="coupon_time" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Nhập số % hoặc tiền giảm</label>
                                                <input id="cc-payment" name="coupon_number" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Ngày bắt đầu</label>
                                                <input id="cc-payment" name="coupon_date_start" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Ngày kết thúc</label>
                                                <input id="cc-payment" name="coupon_date_end" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group" align="center" >
                                                    ...
                                                    <select name="coupon_condition" id="selectSm" class="form-control-sm form-control">
                                                            ...
                                                            <option value="1">giảm theo mã</option>
