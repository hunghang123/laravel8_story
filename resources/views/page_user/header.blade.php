        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="{{URL::to('/trang-chu')}}" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">S</span>Story</h1>
                </a>
            </div>
                ...
                <form action="{{URL::to('/timkiem')}}" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="input-group-text bg-transparent text-primary" name="search" type="submit">
